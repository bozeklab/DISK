...
DISK-create-project --project_path DISK_human_mocap --file_format npy --data_files /home/france/mount_cvg/behavior_data/mocap_dataset/mocap_3djoints/
...
DISK-train --project_path DISK_human_mocap --network gru --dataset_name dataset_20_10  --training_epochs 4 --load_model DISK-gru_dataset_20_10
