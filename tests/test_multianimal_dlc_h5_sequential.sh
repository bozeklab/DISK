...
DISK-create-project --project_path DISK_multianimal_dlc_h5 --file_format dlc_h5 --data_files /home/france/mount_cvg/behavior_data/calms21-disk-dlc/calms21-01.01-snapshot195-dlc-h5/
...
DISK-impute --project_path DISK_multianimal_dlc_h5 --dataset_name dataset1 --model_name DISK-gru_dataset1