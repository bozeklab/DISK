...
DISK-create-project --project_path DISK_DLC_CSV --file_format dlc_csv --data_files /home/france/Mounted_dir/behavior_data/freewalking_20220811_WTTB_fly1_1DLC_resnet50_FreeWalkingMp4Jul30shuffle1_190000.csv
...
DISK-impute --project_path DISK_DLC_CSV --dataset_name test_dlc_csv --model_name test_dlc_csv_DISK-gru
